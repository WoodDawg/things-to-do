    ...
    <div className="mx-auto flex min-h-dvh w-full max-w-xl flex-col">
      ...
      <div className="fixed inset-x-0 bottom-0 z-10 border-t border-gravel/10 bg-card/95 pb-[env(safe-area-inset-bottom)] backdrop-blur">
        <div className="mx-auto max-w-xl px-4 py-3">
          <Link
            href="/places/new"
            className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-spruce font-display text-lg font-semibold uppercase tracking-wide text-white active:bg-spruce-deep"
          >
